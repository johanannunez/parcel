...
export function EntitySection({ entity, members, currentUserId }: EntityProps) {
  // Hide the section entirely for solo entities (1 member, type "individual")
  if (members.length === 1 && entity.type === "individual") {
    return null;
  }
  ...
  return (
    <section id="entity" className="scroll-mt-8">
      ...
      >
        The business entity you&apos;re part of and other members who share access.
      </p>
      ...
      >
        ...
        <p
          ...
          style={{ color: "var(--color-text-tertiary)" }}
        >
          To add or remove members from your entity, contact The Parcel Company.
        </p>
      </div>
    </section>
  );
