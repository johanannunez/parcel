...
import { addPersonToWorkspace, removePersonFromWorkspace } from "@/app/(admin)/admin/workspaces/[workspaceId]/workspace-person-actions";
...
export function PeopleSection({ workspaceId, members }: Props) {
    ...
    <div>
      <header className={s.sectionHeader}>
        ...
        <p className={s.sectionSubtitle}>
          People linked to this workspace. Each person gets their own portal access and communication thread.
        </p>
      </header>
      ...
      <ConfirmModal
        ...
        title="Remove person"
        description={`Remove ${confirmTarget?.fullName ?? "this person"} from the workspace? They will be moved to their own standalone record.`}
        variant="danger"
        confirmLabel="Remove"
