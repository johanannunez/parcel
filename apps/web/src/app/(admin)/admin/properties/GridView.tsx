...
const CATEGORY_META: Record<
  ChecklistCategory,
  { label: string; accent: string; band: string }
> = {
  documents: { label: "Documents", accent: "#3b82f6", band: "#eff5fd" },
  finances: { label: "Finances", accent: "#f59e0b", band: "#fef6ea" },
  listings: { label: "Listings", accent: "#8b5cf6", band: "#f3eefc" },
};
...
function StatusPill({ item }: { item: ChecklistItem }) {
  ...
  return (
    <div ref={ref} style={{ position: "relative", height: "100%", padding: "4px" }}>
      <button
        type="button"
          ...
          {CATEGORY_ORDER.flatMap((category) => {
            ...
            if (!collapsed) {
              templates.forEach((template, rowIdx) => {
                ...
                // fully occludes whatever scrolls behind it.
                const rowBg = zebra ? "#ffffff" : "#fafafa";
