...
import { ArrowSquareOut, CaretDown, RocketLaunch } from "@phosphor-icons/react";
...
const CATEGORY_META: Record<ChecklistCategory, { label: string; color: string }> = {
  documents: { label: "Documents", color: "#3b82f6" },
  finances: { label: "Finances", color: "#f59e0b" },
  listings: { label: "Listings", color: "#8b5cf6" },
};
