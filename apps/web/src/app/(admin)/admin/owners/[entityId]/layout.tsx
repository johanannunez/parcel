...
/**
 * Owner detail layout. Fetches the master list of entities and wraps each
 * owner detail child page in the OwnerListPanel sidebar so the user can
 * navigate between owners while staying in the detail view.
 *
 * The list page at /admin/owners does NOT use this layout and renders
 * full-width.
 */
export default async function OwnerDetailLayout({
  children,
}: {
  children: ReactNode;
}) {
