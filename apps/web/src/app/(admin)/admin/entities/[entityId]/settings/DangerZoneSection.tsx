  ...
  return (
    <div>
      ...
      <section className={x.dangerCard}>
        ...
        <div className={x.dangerBody}>
          Removes the owner profile, entity, properties, and all history. Irreversible. Must be preceded by payout reconciliation.
        </div>
      </section>
    ...
    >
      ...
      >
        ...
        <div style={{ padding: "16px 22px", color: "#3C5266", fontSize: 13, lineHeight: 1.55 }}>
          <p style={{ margin: 0 }}>
            {isDelete
              ? "This removes the owner profile, entity, properties, and all records. This cannot be undone."
