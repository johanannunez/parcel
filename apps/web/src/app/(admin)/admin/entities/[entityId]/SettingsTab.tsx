...
import type { EntityDetailData } from "@/lib/admin/entity-detail-types";
...
export type SettingsTabProps = {
  ...
  /** Override the base path for section routing. Defaults to /admin/entities/:id. */
  basePath?: string;
...
export function SettingsTab({
  ...
  const resolvedBasePath = basePath ?? `/admin/entities/${entity.id}`;
