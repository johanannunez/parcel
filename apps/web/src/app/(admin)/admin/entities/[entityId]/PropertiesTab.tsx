...
import type { EntityContactProperty } from "@/lib/admin/entity-contact-detail";
...
function PropertyCard({ property }: { property: EntityContactProperty }) {
...
function PropertyTable({ properties }: { properties: EntityContactProperty[] }) {
  return (
