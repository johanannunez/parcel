...
import type { EntityBilling } from "@/lib/admin/entity-billing";
...
export function BillingTab({ billing }: { billing: EntityBilling }) {
    ...
    <div className={styles.root}>
      ...
      <div className={styles.card}>
        ...
        {managementFeePercent == null ? (
          <p className={styles.noFee}>No management fee rate set. Edit the entity to add one.</p>
        ) : (() => {
