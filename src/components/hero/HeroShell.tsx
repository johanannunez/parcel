        ...
        >
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-0">
            <div className="group flex flex-1 items-center gap-3 rounded-[var(--radius-md)] px-4 py-3 transition-colors duration-200 hover:bg-white/60 md:border-r md:border-warm-gray-200">
              <MapPin size={20} weight="bold" className="shrink-0 text-brand" />
              <div className="flex-1">
                <label className="text-label text-text-tertiary">Location</label>
                <input type="text" placeholder="Where to?" className="mt-0.5 block w-full bg-transparent text-sm font-medium text-text-primary outline-none placeholder:text-text-tertiary" />
              </div>
            </div>
            <div className="group flex flex-1 items-center gap-3 rounded-[var(--radius-md)] px-4 py-3 transition-colors duration-200 hover:bg-white/60 md:border-r md:border-warm-gray-200">
              <CalendarBlank size={20} weight="bold" className="shrink-0 text-brand" />
              <div className="flex-1">
                <label className="text-label text-text-tertiary">Check in</label>
                <input type="text" placeholder="Add date" className="mt-0.5 block w-full bg-transparent text-sm font-medium text-text-primary outline-none placeholder:text-text-tertiary" />
              </div>
            </div>
            <div className="group flex flex-1 items-center gap-3 rounded-[var(--radius-md)] px-4 py-3 transition-colors duration-200 hover:bg-white/60 md:border-r md:border-warm-gray-200">
              <CalendarBlank size={20} weight="bold" className="shrink-0 text-brand" />
              <div className="flex-1">
                <label className="text-label text-text-tertiary">Check out</label>
                <input type="text" placeholder="Add date" className="mt-0.5 block w-full bg-transparent text-sm font-medium text-text-primary outline-none placeholder:text-text-tertiary" />
              </div>
            </div>
            <div className="group flex flex-1 items-center gap-3 rounded-[var(--radius-md)] px-4 py-3 transition-colors duration-200 hover:bg-white/60">
              <Users size={20} weight="bold" className="shrink-0 text-brand" />
              <div className="flex-1">
                <label className="text-label text-text-tertiary">Guests</label>
                <input type="text" placeholder="Add guests" className="mt-0.5 block w-full bg-transparent text-sm font-medium text-text-primary outline-none placeholder:text-text-tertiary" />
              </div>
            </div>
